...
pub use stoffel_vm_types::core_types::{Value, ShareData, ShareType, Upvalue, Closure, F64};
...
impl From<crate::bytecode::Constant> for Value {
    fn from(constant: crate::bytecode::Constant) -> Self {
        match constant {
            ...
            crate::bytecode::Constant::Share(share_type, data) => {
                Value::Share(share_type, ShareData::Opaque(data))
            }
        }
    }
}
